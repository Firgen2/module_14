  ...
  return (
    <div className={style.ticker} ref={tickerRef}>
      <div className={style.tickerContent}>
        {/* Первый блок */}
        <div className={style.firstBlock} style={{ animationDuration: `${animationDuration}s` }}>
        ...
        {/* Второй блок (копия) */}
        <div className={style.secondBlock} style={{ animationDelay: `${animationDuration}s`, animationDuration: `${animationDuration}s` }}>
          {texts.map((text, index) => (
